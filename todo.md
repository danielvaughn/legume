...
- [x] Define Markdown frontmatter for title, summary, publication status,
      ordering, and dates. Résumé linkage intentionally stays in
      `resume.yaml` (`post:` fields) so it has a single source of truth.
